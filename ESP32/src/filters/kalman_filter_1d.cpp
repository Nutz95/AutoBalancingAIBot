...
public:
  KalmanFilter1D() {
    angle_ = 0.0f; bias_ = 0.0f;
    P00 = 1e-3f; P01 = 0.0f; P10 = 0.0f; P11 = 1e-3f;
    Q_angle = 1e-4f; Q_bias = 1e-5f; R_measure = 0.03f;
    rate_ = 0.0f;
  }
  void begin(const fusion::FusionConfig &cfg) override { (void)cfg; }
  unsigned long getWarmupDurationMs() const override { return IMU_FILTER_WARMUP_MS_KALMAN1D; }
